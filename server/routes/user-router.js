...
const BadParams = errors.BadParamsError;
const BadCredentials = errors.BadCredentialsError;
...
router.post('/admin-signup', (req, res, next) => {
  ...
  Promise.resolve(req.body.credentials)
    ...
    .then(() => bcrypt.hash(req.body.credentials.password, saltRounds))
    .then(hash => {
...
router.delete('/admin-signout', requireToken, (req, res, next) => {
